...
if [ -z "$SOLANA_DOWNLOAD_ROOT" ]; then
    SOLANA_DOWNLOAD_ROOT="https://github.com/allnodes/solana-harmonic-jito/releases/download"
fi
GH_LATEST_RELEASE="https://api.github.com/repos/allnodes/solana-harmonic-jito/releases/latest"
